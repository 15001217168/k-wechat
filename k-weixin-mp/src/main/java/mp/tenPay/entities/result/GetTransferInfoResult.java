...
/**
 * @Author:Jrss
 * @Desp:商户的企业付款操作进行结果查询，返回付款操作详细结果
 * @Date:Create in 17:51 2018/6/21
 * @Modified By:
 */
public class GetTransferInfoResult extends TenPayResult {
    ...
    public GetTransferInfoResult(String resultXml) {
        super(resultXml);
        if (super.isReturnCodeSuccess()) {
            ...
            if (isResultCodeSuccess()) {
                ...
                payment_amount = Integer.parseInt(getXmlValue("payment_amount"));
